...
const FreeStudyPage = () => {
  ...
  if (sessionFinished) {
    return (
      <div className="flex flex-col items-center justify-center min-h-screen text-center p-4">
        <h1 className="text-3xl font-bold mb-4">🎉 Baralho Concluído! 🎉</h1>
        <p className="text-xl">Você revisou todos os cartões deste baralho.</p>
        <Link
          to={`/decks/${deckId}`}
  ...
  if (!currentCard) {
    return (
      <div className="p-8 text-center">Este baralho não possui cartões.</div>
    );
  }
